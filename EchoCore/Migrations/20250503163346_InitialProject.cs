        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entries_Threads_ThreadId",
                        column: x => x.ThreadId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SemanticMemoryEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SemanticMemoryEntries_Threads_ThreadId",
                        column: x => x.ThreadId,
                        principalTable: "Threads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entries_ThreadId",
                table: "Entries",
                column: "ThreadId");

            migrationBuilder.CreateIndex(
                name: "IX_SemanticMemoryEntries_ThreadId",
